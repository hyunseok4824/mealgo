...
1. 방법 (나의 풀이)<br>
    1. 비트마스킹으로 가능한 조합(집합의 부분집합)을 다 구하면서 조건 만족하는 지 확인 <br>
    2. 사전순 검사 하는 함수<br>
	    - 접두사 기준으로 더 작은지 확인
	    - 더 짧은 쪽(size)
    3. 비트마스킹을 다시 부분 원소 출력으로 바바꾸는 함수<br> 
...
## 03. 회고
- *주의 !!* DFS VS 비트마스킹<br>
N <= 15일 때는 시간 복잡도가 거의 동일 - 아무거나 써도 됨<br>
구현하기는 비트마스킹이 훨씬 편한 듯
